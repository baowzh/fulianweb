...
<div class="pad-lr-10">
<form action="?m=mail&c=mail&a=add_type" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<th width="100"><?php echo L('mail_type_listorder')?>：</th>
	...
	<tr>
		<th></th>
		<td><input type="hidden" name="forward" value="?m=mail&c=mail&a=add_type"> <input
