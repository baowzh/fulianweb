...
'cookie_pre' => 'uSrzB_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://www.nmwomen.org.cn/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://127.0.0.1/emegtaiqud/statics/js/', //CDN JS
'css_path' => 'http://127.0.0.1/emegtaiqud/statics/css/', //CDN CSS
'img_path' => 'http://127.0.0.1/emegtaiqud/statics/images/', //CDN img
'app_path' => 'http://127.0.0.1/emegtaiqud/',//动态域名配置地址
...
'gzip' => 0, //是否Gzip压缩后输出
'auth_key' => 'SYGLzQv70uwNY1tgqqBC', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.nmwomen.org.cn/phpsso_server',	//接口地址
'phpsso_auth_key' => 'gUF8pVWCytZ2LNNRpYsiog7doKgryP76', //加密密钥
