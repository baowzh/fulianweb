...
(function($){
	$.fn.SlideVer=function(options){
		var opts = $.extend({},$.fn.SlideVer.deflunt,options);
		var index=1;
		...
		return this.each(function() {
			...
			//滚动函数
			var doPlay=function(){
				$.fn.SlideVer.effect[opts.effect](ContentBox, targetLi, index, slideWH, opts);
				index++;
			...
			clickNext.click(function(event){
				$.fn.SlideVer.effectLoop.scroolLeft(ContentBox, targetLi, index, slideWH, opts,function(){
			...
			clickPrev.click(function(event){
				...
				$.fn.SlideVer.effectLoop.scroolRight(ContentBox, targetLi, index, slideWH, opts);
				event.preventDefault();
			});
			//自动播放
			if (opts.autoPlay) {
